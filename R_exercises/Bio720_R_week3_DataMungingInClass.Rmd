...
Questions:
I made two functions that handle all of the data analysis for our lab how can I make a package/ explain it easily to people who have no R skills.
Mention that I did part of the assignment wrong but updated it on github
## Brief introduction
...
none in clean but 2 are in dll_data
...
It has two since when the data was stored the levels were stored with it as a factor
```{r}
...
#basically cuts off characters 1:5
head(line_names)
tail(line_names)
```
